...
ESAddBillItem2::~ESAddBillItem2()
{

}

void ESAddBillItem2::slotSearch()
{
...
void ESAddBillItem2::keyPressEvent(QKeyEvent * event)
{
	switch (event->key())
	{
	case Qt::Key_Return:
...
void ESAddBillItem2::addToBill(QString stockId)
{
...
void ESAddBillItem2::slotHideImages()
{
...
void ESAddBillItem2::slotItemDoubleClicked(int row, int col)
{
	QTableWidgetItem* idCell = ui.tableWidget->item(row, 0);
	if (!idCell)
		return;
