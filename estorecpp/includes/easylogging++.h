...
#   if ELPP_OS_UNIX
#      if ELPP_OS_ANDROID
    static const char* kDefaultLogFile                         =      "logs/Progex.%datetime{%Y%M%d_%H%m%s}.log";
#      else
    static const char* kDefaultLogFile                         =      "logs/Progex.%datetime{%Y%M%d_%H%m%s}.log";
#      endif  // ELPP_OS_ANDROID
#   elif ELPP_OS_WINDOWS
    static const char* kDefaultLogFile                         =      "D:\\progex\\logs\\Progex.%datetime{%Y%M%d_%H%m%s}.log";
#   endif  // ELPP_OS_UNIX
